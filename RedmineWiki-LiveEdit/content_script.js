...
(function() {
  ...
  if (/redmine/.test(url) && (/\/edit$/.test(url) || /\/edit\?.+$/.test(url))) {
    ...
    (function(document, xhr) {
      ...
      inlineCSS = ".jstEditor { overflow: hidden; float: none; display: inline-block; } #content_text { box-sizing: border-box; position: relative; float: left; width: 29.5%; max-width: 30%; height: 89.5vh; max-height: 90vh; } #preview { float: right; width: 69.5%; max-width: 70%; height: 89.5vh; max-height: 90vh; overflow: scroll; } #preview fieldset { margin-top: 0; } #preview legend { display: none; }";
      LiveEdit = (function() {
        function LiveEdit() {
